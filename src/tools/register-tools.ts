...
registerTool({
  ...
  enabled: true
}, async (args: Record<string, any>) => NotificationTools.sendDesktopNotification(args as { title: string; message: string; icon?: string; sound?: boolean; timeout?: number; }));
...
registerTool({
  ...
  enabled: true
}, async (args: Record<string, any>) => NotificationTools.sendSystemAlert(args as { title: string; message: string; urgency?: 'low' | 'normal' | 'critical'; }));
...
registerTool({
  ...
  enabled: true
}, async (args: Record<string, any>) => LintingTools.lintFrontend(args as { fix?: boolean; files?: string[]; config?: string; }));
...
registerTool({
  ...
  enabled: true
}, async (args: Record<string, any>) => FormattingTools.formatFrontend(args as { checkOnly?: boolean; files?: string[]; config?: string; }));
