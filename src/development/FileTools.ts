...
import { ToolDefinition, ToolExecutionContext, ParameterType } from "../core/types";
...
export class ReadFileTool extends BaseTool {
   ...
   * @example
   */
  protected async executeImpl(parameters: Record<string, any>, _context: ToolExecutionContext): Promise<any> {
