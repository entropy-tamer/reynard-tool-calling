    ...
    async def execute_streaming(
        ...
        **params,
        ...
        try:
            ...
            logger.exception(f"Error in streaming example tool: {e}")
        ...
        try:
            ...
            for i in range(5):
                ...
                if should_fail and (i + 1) == fail_step:
                    msg = f"Simulated failure at step {fail_step}"
                    raise Exception(msg)
            ...
            logger.exception(f"Error in streaming error example tool: {e}")
