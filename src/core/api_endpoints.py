...
async def search_tools(
    ...
    try:
        ...
        logger.exception(f"Error searching tools with query '{query}': {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_tool_info(
    ...
    try:
        ...
        logger.exception(f"Error getting tool info for '{tool_name}': {e}")
        raise HTTPException(status_code=500, detail=str(e))
...
async def get_tool_categories(
    ...
    try:
        ...
        logger.exception(f"Error getting tool categories: {e}")
        raise HTTPException(status_code=500, detail=str(e))
