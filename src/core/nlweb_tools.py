...
async def nlweb_ask_tool(
    ...
    try:
        ...
        logger.exception(f"Error in nlweb.ask tool: {e}")
...
async def nlweb_list_sites_tool() -> dict[str, Any]:
    ...
    try:
        ...
        logger.exception(f"Error in nlweb.list_sites tool: {e}")
        return {"success": False, "error": f"Tool execution failed: {e!s}"}
...
async def nlweb_mcp_tool(
    ...
    try:
        ...
        logger.exception(f"Error in nlweb.mcp tool: {e}")
        return {"success": False, "error": f"Tool execution failed: {e!s}"}
...
async def nlweb_suggest_tool(
    ...
    try:
        ...
        logger.exception(f"Error in nlweb.suggest tool: {e}")
        return {"success": False, "error": f"Tool execution failed: {e!s}"}
